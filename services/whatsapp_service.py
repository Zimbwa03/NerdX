    ...
    def send_audio_message(self, to: str, audio_file_path: str) -> bool:
        ...
        try:
            ...
            with open(audio_file_path, 'rb') as audio_file:
                ...
                upload_response = requests.post(upload_url, headers=self.headers, files=files, timeout=60)
            ...
            response = requests.post(send_url, headers=self.headers, json=data, timeout=30)
            ...
            for entry in data['entry']:
                ...
                for change in entry['changes']:
                    ...
                    for message in messages:
                        # Check for active AI question session
                        if message.get('type') == 'interactive' and message.get('interactive', {}).get('type') == 'button_reply':
                            ...
                            if 'ai_question' in reply_id: # Assuming your AI questions have 'ai_question' in their IDs
                                return {
                                    ...
                                    'text': '', # No text for button replies
                                    'image': {},
                                    'document': {}
                                }
