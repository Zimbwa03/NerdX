...
class MathematicsService:
    ...
    def get_difficulty_menu_buttons(self, topic: str) -> List[Dict]:
        """Get difficulty selection buttons for a specific topic"""
        topic_encoded = topic.lower().replace(' ', '_')
        
        return [
            {"text": "🟢 Easy (5 Credits)", "callback_data": f"math_question_{topic_encoded}_easy"},
            {"text": "🟡 Medium (10 Credits)", "callback_data": f"math_question_{topic_encoded}_medium"},
            {"text": "🔴 Difficult (15 Credits)", "callback_data": f"math_question_{topic_encoded}_difficult"},
            {"text": "🔙 Back to Math Menu", "callback_data": "mathematics_mcq"},
...
🎯 **Difficulty Levels:**
🟢 **Easy** (5 Credits) - Basic concepts & formulas
🟡 **Medium** (10 Credits) - Applied problems  
🔴 **Difficult** (15 Credits) - Complex reasoning

💡 All questions generated with **DeepSeek AI** for authentic ZIMSEC experience!
...
🟢 **Easy** (5 Credits)
└ {self.difficulty_descriptions['easy']}

🟡 **Medium** (10 Credits)  
└ {self.difficulty_descriptions['medium']}

🔴 **Difficult** (15 Credits)
└ {self.difficulty_descriptions['difficult']}

💡 **DeepSeek AI** generates authentic ZIMSEC-style problems with step-by-step solutions!
