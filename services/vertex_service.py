...
# Credit costs for quiz image vs text questions (units, 1 credit = 10 units)
IMAGE_QUESTION_CREDIT_COST = 10  # 1 credit per image question
TEXT_QUESTION_CREDIT_COST = 5   # 0.5 credit per text question
