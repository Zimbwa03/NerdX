 ...
 * Features deep space biology theme, Question Generation, and separated Notes
 */
...
import { ArrowLeft, TrendingUp, BookOpen, Atom, Microscope, FlaskConical, Play, Dna, Info, X, Check, FileText } from 'lucide-react';
...
export const BiologyTopicsPage = () => {
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                // Fetch topics for Biology directly
    ...
    const minCredits = getMinimumCreditsForQuiz({
        ...
        questionFormat: questionFormat // structured usually costs more
    });
            ...
            if (question) {
                ...
                navigate('/app/sciences/quiz', {
                    state: {
                        ...
                        subject: SUBJECT,
                        topic: pendingTopic,
                        parentSubject: 'Biology', // For backwards compatibility
                        questionFormat,
                        backTo: '/app/biology' // Custom back link
                    },
                });
            } else {
            ...
            <div className="science-content-grid">
                ...
                <div className="science-features-col">
                    ...
                    <div
                        ...
                        onClick={() => navigate('/app/teacher', { state: { subject: 'O Level Biology', gradeLevel: 'Form 3-4 (O-Level)' } })}
                    >
                    ...
                    <div
                        className="science-feature-card"
                        onClick={() => navigate('/app/exam/setup', { state: { subject: 'biology', backTo: '/app/biology', subjectLabel: 'Biology' } })}
                    >
                        <div className="feature-icon-box">
                            <FileText size={28} />
                        </div>
                ...
                <div className="modal-overlay" style={{
                    ...
                    <div className="modal-content" style={{
                        ...
                        <div style={{ textAlign: 'center', marginBottom: 24 }}>
                            <div style={{
                                width: 60, height: 60, background: 'rgba(16, 185, 129, 0.2)',
                        ...
                        <div className="format-options" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 24 }}>
                            <button
                                ...
                                style={{
                                    padding: 20, borderRadius: 16, border: `2px solid ${questionFormat === 'mcq' ? '#10B981' : 'rgba(255,255,255,0.1)'}`,
                                    background: questionFormat === 'mcq' ? 'rgba(16, 185, 129, 0.1)' : 'rgba(255,255,255,0.05)',
                            ...
                            <button
                                ...
                                style={{
                                    padding: 20, borderRadius: 16, border: `2px solid ${questionFormat === 'structured' ? '#10B981' : 'rgba(255,255,255,0.1)'}`,
                                    background: questionFormat === 'structured' ? 'rgba(16, 185, 129, 0.1)' : 'rgba(255,255,255,0.05)',
                                    color: '#fff', cursor: 'pointer', textAlign: 'center'
                                }}
                            >
