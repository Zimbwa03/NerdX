...
import { getTopicNotesBySlug } from '../../data/besNotes/notes';
...
export function BESNoteDetailPage() {
  ...
  if (!topicSlug || !notes) {
    return (
      <div className="commerce-notes-page">
        <Link to="/app/business-enterprise-skills/notes" className="back-link">
  ...
  return (
    <div className="commerce-notes-page commerce-notes-detail-page bes-notes-detail-page">
      <header className="commerce-notes-detail-header">
        <Link to="/app/business-enterprise-skills/notes" className="back-link">
          <ArrowLeft size={20} /> Back to topics
        </Link>
        <span className="commerce-notes-detail-subtitle">Business Enterprise and Skills Notes</span>
