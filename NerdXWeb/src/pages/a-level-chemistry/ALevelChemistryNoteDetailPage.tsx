...
export function ALevelChemistryNoteDetailPage() {
  ...
  useEffect(() => {
    ...
    const topicNotes = aLevelChemistryNotes[topicMeta.name];
  ...
  if (loading) {
    return (
      <div className="science-universe-page chem loading-screen">
        ...
        <div className="loading-text">Loading A-Level Chemistry Notes...</div>
      </div>
    );
  }
    ...
    return (
      <div className="science-universe-page chem">
        ...
        <div className="science-hero">
          ...
          <p>The requested A-Level Chemistry notes could not be found.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="science-universe-page chem">
      ...
      <div className="science-notes-header-bar glass-panel">
        <Link to="/app/a-level-chemistry" className="back-link">
          <ArrowLeft size={20} /> Back
        </Link>
        <div className="header-breadcrumbs">
          <span className="crumb-subject" style={{ color: ACCENT_COLOR }}>A-Level Chemistry</span>
