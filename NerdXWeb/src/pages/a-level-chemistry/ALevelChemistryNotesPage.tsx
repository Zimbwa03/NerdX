...
import { aLevelChemistryTopics } from '../../data/aLevelChemistry';
import '../sciences/ScienceUniverse.css';

type ChemistryLevel = 'AS Level' | 'A2 Level';

export function ALevelChemistryNotesPage() {
    ...
    <div className="science-universe-page chem">
      ...
      <div className="science-hero">
        ...
        >
          ...
          <span>A-LEVEL CHEMISTRY NOTES</span>
        </div>
        <h1
        ...
        <p style={{ maxWidth: 650, margin: '0 auto', opacity: 0.8 }}>
          Full A-Level Chemistry notes with summaries, detailed sections, key points, and exam tips.
        </p>
      </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
            <button
              ...
              style={{
                padding: '8px 12px',
                borderRadius: 10,
                border: selectedLevel === 'AS Level' ? '1px solid rgba(20, 184, 166, 0.45)' : '1px solid rgba(255,255,255,0.12)',
                background: selectedLevel === 'AS Level' ? 'rgba(20, 184, 166, 0.18)' : 'rgba(255,255,255,0.05)',
                color: '#fff',
                cursor: 'pointer',
              }}
            >
            ...
            <button
              ...
              style={{
                padding: '8px 12px',
                borderRadius: 10,
                border: selectedLevel === 'A2 Level' ? '1px solid rgba(20, 184, 166, 0.45)' : '1px solid rgba(255,255,255,0.12)',
                background: selectedLevel === 'A2 Level' ? 'rgba(20, 184, 166, 0.18)' : 'rgba(255,255,255,0.05)',
                color: '#fff',
                cursor: 'pointer',
              }}
            >
