...
export function ALevelComputerScienceNotesPage() {
  ...
  return (
    <div className="science-universe-page cs">
      ...
      <Link to="/app/a-level-computer-science" className="super-back-btn">
        <ArrowLeft size={18} />
        <span>Back</span>
      </Link>
      ...
      <div className="science-hero" style={{ paddingBottom: 20 }}>
        ...
        <p style={{ maxWidth: 600, margin: '0 auto', opacity: 0.8 }}>
          Notes and references for A-Level Computer Science study.
        </p>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: 10, marginTop: 24, flexWrap: 'wrap' }}>
          <button
            ...
            style={{
              padding: '10px 22px',
              borderRadius: 50,
              border: `2px solid ${board === 'zimsec' ? '#1976D2' : 'rgba(255,255,255,0.15)'}`,
              background: board === 'zimsec' ? 'rgba(25, 118, 210, 0.25)' : 'rgba(255,255,255,0.05)',
          ...
          <button
            ...
            style={{
              padding: '10px 22px',
              borderRadius: 50,
              border: `2px solid ${board === 'cambridge' ? '#1976D2' : 'rgba(255,255,255,0.15)'}`,
              background: board === 'cambridge' ? 'rgba(25, 118, 210, 0.25)' : 'rgba(255,255,255,0.05)',
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 20px 80px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
          <Monitor size={24} style={{ color: '#90CAF9' }} />
          <span style={{ fontSize: 22, fontWeight: 700 }}>Topics</span>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          {computerScienceTopicNames.map((name, index) => {
            ...
            return (
              <Link
                key={name}
                to={`/app/a-level-computer-science/notes/${slug}`}
                style={{
                  display: 'flex',
                  alignItems: 'center',
                  gap: 16,
              ...
              >
                <div style={{
                  ...
                  <TopicIcon size={22} color="#90CAF9" />
                </div>
