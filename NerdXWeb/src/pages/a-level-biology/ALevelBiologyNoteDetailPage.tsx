...
import { aLevelBiologyNotes, getTopicById, aLevelBiologyTopics } from '../../data/aLevelBiology';
...
export function ALevelBiologyNoteDetailPage() {
  ...
  const topicIndex = useMemo(() => {
    if (!topicId) return 0;
    return aLevelBiologyTopics.findIndex(t => t.id === topicId);
  }, [topicId]);
  ...
  useEffect(() => {
    ...
    const topicNotes = aLevelBiologyNotes[topicMeta.name];
  ...
  if (loading) {
    return (
      <div className="science-universe-page bio loading-screen">
        ...
        <div className="loading-text">Loading A-Level Biology Notes...</div>
      </div>
    );
  }
    ...
    return (
      <div className="science-universe-page bio">
        ...
        <div className="science-hero">
          ...
          <p>The requested A-Level Biology notes could not be found.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="science-universe-page bio">
      ...
      <div className="science-notes-header-bar glass-panel">
        <Link to="/app/a-level-biology" className="back-link">
          <ArrowLeft size={20} /> Back
        </Link>
        <div className="header-breadcrumbs">
          <span className="crumb-subject" style={{ color: ACCENT_COLOR }}>A-Level Biology</span>
