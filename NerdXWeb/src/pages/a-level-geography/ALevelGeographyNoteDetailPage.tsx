...
import { aLevelGeographyNotes, getTopicById, aLevelGeographyTopics } from '../../data/aLevelGeography';
...
export function ALevelGeographyNoteDetailPage() {
  ...
  const topicIndex = useMemo(() => {
    if (!topicId) return 0;
    return aLevelGeographyTopics.findIndex(t => t.id === topicId);
  }, [topicId]);
  ...
  useEffect(() => {
    ...
    const topicNotes = aLevelGeographyNotes[topicMeta.name];
  ...
  if (loading) {
    return (
      <div className="science-universe-page geo loading-screen">
        ...
        <div className="loading-text">Loading A-Level Geography Notes...</div>
      </div>
    );
  }
    ...
    return (
      <div className="science-universe-page geo">
        ...
        <div className="science-hero">
          ...
          <p>The requested A-Level Geography notes could not be found.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="science-universe-page geo">
      ...
      <div className="science-notes-header-bar glass-panel">
        <Link to="/app/a-level-geography" className="back-link">
          <ArrowLeft size={20} /> Back
        </Link>
        <div className="header-breadcrumbs">
          <span className="crumb-subject" style={{ color: ACCENT_COLOR }}>A-Level Geography</span>
