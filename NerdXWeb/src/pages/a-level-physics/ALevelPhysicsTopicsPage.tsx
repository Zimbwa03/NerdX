...
type PhysicsQuestionType = 'mcq' | 'structured';
...
const TOPIC_ICONS: Record<string, LucideIcon> = {
  physical_quantities: Circle,
  kinematics: Circle,
  dynamics: Circle,
  forces_pressure: Circle,
  work_energy_power: Circle,
  deformation_solids: Circle,
  waves: FlaskConical,
  superposition: FlaskConical,
  electricity: Circle,
  dc_circuits: Circle,
  particle_physics: Circle,
  circular_motion: Circle,
  gravitational_fields: Circle,
  temperature: Circle,
  ideal_gases: Circle,
  thermodynamics: Circle,
  oscillations: Circle,
  electric_fields: Circle,
  capacitance: Circle,
  magnetic_fields: Circle,
  alternating_currents: Circle,
  quantum_physics: Circle,
  nuclear_physics: Circle,
  astronomy_cosmology: Circle,
};

export function ALevelPhysicsTopicsPage() {
  ...
  const [pendingTopic, setPendingTopic] = useState<ALevelPhysicsTopic | null>(null);
  const [selectedQuestionType, setSelectedQuestionType] = useState<PhysicsQuestionType>('mcq');
  ...
  const openStartQuiz = (topic: ALevelPhysicsTopic) => {
    ...
    <div className="science-universe-page phys">
      ...
      <div className="science-hero">
        ...
        >
          ...
          <span>A-LEVEL PHYSICS (9702)</span>
        </div>
        <h1
      ...
      <div className="science-content-grid">
        <div className="science-features-col">
          <div className="science-feature-card" onClick={() => navigate('/app/a-level-physics/notes')}>
            <div className="feature-icon-box" style={{ background: 'rgba(59, 130, 246, 0.18)' }}>
              <BookOpen size={28} color="#67E8F9" />
            </div>
            <h3 className="feature-card-title">Physics Notes</h3>
          ...
          <div
            ...
            onClick={() =>
              navigate('/app/teacher', {
                state: { subject: 'A Level Physics', gradeLevel: 'AS Level - A2 Level' },
              })
            }
          >
          ...
          <div className="science-feature-card" onClick={() => navigate('/app/virtual-lab?subject=physics')}>
            ...
            <p className="feature-card-desc">Interactive physics experiments and simulations.</p>
          </div>
        ...
        <div className="science-topics-col">
          <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12, marginBottom: 18, flexWrap: 'wrap' }}>
            <div className="topics-section-title" style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              <Play size={24} style={{ color: '#67E8F9' }} />
              ...
              return (
                <div key={topic.id} className="science-topic-card" onClick={() => openStartQuiz(topic)}>
                  ...
                  <div style={{ display: 'flex', gap: 8, marginTop: 8, flexWrap: 'wrap' }}>
                    <span style={{ fontSize: 11, padding: '2px 8px', borderRadius: 999, background: 'rgba(59,130,246,0.18)', color: '#67E8F9' }}>
                      {topic.difficulty}
                    </span>
                  </div>
                </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 8 }}>
              <button
                ...
                style={{
                  padding: '10px 12px',
                  borderRadius: 10,
                  border: selectedQuestionType === 'mcq' ? '1px solid #67E8F9' : '1px solid rgba(255,255,255,0.15)',
                  background: selectedQuestionType === 'mcq' ? 'rgba(103, 232, 249, 0.18)' : 'rgba(255,255,255,0.05)',
                  color: '#fff',
                  cursor: 'pointer',
                  textAlign: 'left',
                }}
              ...
              <button
                ...
                style={{
                  padding: '10px 12px',
                  borderRadius: 10,
                  border: selectedQuestionType === 'structured' ? '1px solid #67E8F9' : '1px solid rgba(255,255,255,0.15)',
                  background:
      ...
      <AILoadingOverlay
        ...
        subtitle="Creating your A-Level Physics practice question"
