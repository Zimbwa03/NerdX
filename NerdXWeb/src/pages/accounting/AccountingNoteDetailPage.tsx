...
export function AccountingNoteDetailPage() {
  ...
  useEffect(() => {
    ...
    const topicNotes = accountingNotes[topicMeta.name];
  ...
  if (loading) {
    return (
      <div className="science-universe-page acc loading-screen">
        ...
        <div className="loading-text">Loading Accounting Notes...</div>
      </div>
    );
  }
    ...
    return (
      <div className="science-universe-page acc">
        ...
        <div className="science-hero">
          ...
          <p>The requested accounting notes could not be found.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="science-universe-page acc">
      ...
      <div className="science-notes-header-bar glass-panel">
        <Link to="/app/accounting" className="back-link">
          <ArrowLeft size={20} /> Back
        </Link>
        <div className="header-breadcrumbs">
          <span className="crumb-subject" style={{ color: ACCENT_COLOR }}>Accounting</span>
