...
const ALevelChemistryScreen: React.FC = () => {
    ...
    const [selectedTopic, setSelectedTopic] = useState<ALevelChemistryTopic | null>(null);
    ...
    return (
        <View style={[styles.container, { backgroundColor: isDarkMode ? '#0D0F1C' : '#F8F9FC' }]}>
            ...
            <LoadingProgress
                ...
                message="Preparing your Chemistry question..."
                estimatedTime={6}
            />
                    ...
                    <Pressable style={[styles.modalContent, { backgroundColor: isDarkMode ? '#1A1D2E' : '#FFFFFF' }]} onPress={e => e.stopPropagation()}>
                        ...
                        <View style={styles.modalHeader}>
                            <View style={styles.modalTitleContainer}>
                                <Ionicons name="flask-outline" size={24} color="#00897B" />
                        ...
                        <TouchableOpacity
                            style={[
                                styles.formatOption,
                                { 
                                    backgroundColor: isDarkMode ? 'rgba(0, 137, 123, 0.08)' : 'rgba(0, 137, 123, 0.05)',
                                    borderColor: selectedQuestionFormat === 'mcq' ? '#00897B' : isDarkMode ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.1)',
                            ...
                            activeOpacity={0.8}
                        >
                            <View style={[styles.formatIconContainer, { backgroundColor: 'rgba(0, 137, 123, 0.15)' }]}>
                                <MaterialCommunityIcons name="checkbox-marked-circle-outline" size={28} color="#00897B" />
                            </View>
                            ...
                            {selectedQuestionFormat === 'mcq' && (
                                <Ionicons name="checkmark-circle" size={24} color="#00897B" />
                            )}
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity
                            style={[
                                styles.formatOption,
                                { 
                                    backgroundColor: isDarkMode ? 'rgba(123, 31, 162, 0.08)' : 'rgba(123, 31, 162, 0.05)',
                                    borderColor: selectedQuestionFormat === 'structured' ? '#7B1FA2' : isDarkMode ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.1)',
                            ...
                            activeOpacity={0.8}
                        >
                            <View style={[styles.formatIconContainer, { backgroundColor: 'rgba(123, 31, 162, 0.15)' }]}>
                                <MaterialCommunityIcons name="file-document-edit-outline" size={28} color="#7B1FA2" />
                            </View>
                            <View style={styles.formatTextContainer}>
                                <Text style={[styles.formatTitle, { color: isDarkMode ? '#FFFFFF' : '#1A1A2E' }]}>
                                    Structured (Paper 2)
                                ...
                                <Text style={[styles.formatDescription, { color: isDarkMode ? 'rgba(255,255,255,0.6)' : 'rgba(26,26,46,0.6)' }]}>
                                    ZIMSEC-style with parts (a), (b), (c) • Speech-to-text input
                                </Text>
                            </View>
