// Dedicated interactive screen for data-driven simulations (Phase 3 and beyond)
...
const VirtualLabInteractiveScreen: React.FC = () => {
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
        ...
        <HandsOnActivityRenderer
          ...
          onProgress={(p) => {
            ...
            // completion rules depend on activity type
...
export default VirtualLabInteractiveScreen;
