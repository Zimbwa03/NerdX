#!/usr/bin/env python3
"""
Fixed Payment Flow Test Script
Tests the complete payment system with correct parameters
"""
...
def test_payment_service():
    ...
    try:
        ...
        for package in packages:
            print(f"   📦 {package['name']}: ${package['price']} for {package['credits']} credits (ID: {package['id']})")
...
def test_payment_flow():
    ...
    try:
        ...
        # Test payment reference generation with correct package ID
        test_user_id = "263785494594"
        test_package_id = "pocket"  # Use actual package ID from the service
...
def test_payment_proof_submission():
    ...
    try:
        ...
        # Test data with correct package ID
        test_user_id = "263785494594"
        test_package_id = "pocket"  # Use actual package ID
        test_reference = "TEST_REF_001"
        test_proof = "Test payment proof screenshot"
        
        # Try to submit payment proof with correct method signature
...
def main():
    """Run all tests"""
    print("🚀 NerdX Payment System Test Suite (FIXED)")
    print("=" * 50)
    
    # Set up environment first
    setup_environment()
    
    print("\n🎯 Testing complete payment system flow...")
