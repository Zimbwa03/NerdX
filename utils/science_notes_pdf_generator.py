...
class ScienceNotesPDFGenerator:
    ...
    def _add_watermark(self, canvas_obj, doc):
        ...
        # Set transparency using setFillAlpha (separate from RGB)
        canvas_obj.setFillAlpha(0.3)
        canvas_obj.setFillColorRGB(0.9, 0.9, 0.9)
        canvas_obj.translate(A4[0]/2, A4[1]/2)
        canvas_obj.rotate(45)
        canvas_obj.drawCentredString(0, 0, "NerdX AI")
    ...
    def generate_notes_pdf(
        ...
        """
        Generate a professional science notes PDF with watermark
        ...
        try:
            ...
            # Create PDF document with watermark
            ...
            content.append(self._create_divider())
            footer_text = "Generated by Combined Science Teacher Bot • NerdX AI • ZIMSEC Quiz Bot"
            content.append(Paragraph(footer_text, self.styles['Footer']))
            
            # Build PDF with watermark
            doc.build(content, onFirstPage=self._add_watermark, onLaterPages=self._add_watermark)
